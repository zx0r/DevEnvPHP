...
setup_xclean_structure() {
  echo "Создаю структуру сайта xClean.app..."

  # Страницы: slug -> "Заголовок|Содержимое"
  declare -A pages=(
    ["home"]="Главная|Добро пожаловать в xClean — цифровую химчистку и прачечную в Москве."
    ["services"]="Услуги|Наши услуги: химчистка, стирка, глажка и доставка."
    ["about"]="О нас|Информация о компании xClean."
    ["contacts"]="Контакты|Свяжитесь с нами: адрес, телефон, email."
  )
  declare -A page_ids=()
  ...
  echo "🎉 Структура сайта xClean.app успешно создана"
}
# post_install_config() {
